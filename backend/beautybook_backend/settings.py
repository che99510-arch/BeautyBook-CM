"""
Django settings for beautybook_backend project.
...
# Also allow any local network IP in DEBUG mode
if DEBUG:
    import socket
    try:
...
# In DEBUG, allow all origins so any local IP works without restarting
